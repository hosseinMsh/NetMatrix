...
# Configuration
DEFAULT_PORTS="20,21,22,23,25,53,67,68,80,110,143,161,194,443,465,587,993,995,3306,3389,5432,8080,8443,9000,27017,6379"
TIMEOUT=2
MAX_RETRIES=2
...
show_progress() {
    ...
    echo -ne "Progress: [$(printf "%-50s" "=" | tr ' ' '=')] $percent% ($current/$total)\n"
}
